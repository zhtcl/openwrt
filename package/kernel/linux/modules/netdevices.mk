...
define KernelPackage/switch-mvsw61xx
  ...
  DEPENDS:=@!LINUX_5_4 +kmod-swconfig
...
define KernelPackage/gigaset
  ...
  DEPENDS:=@!LINUX_5_4 @USB_SUPPORT +kmod-isdn4linux +kmod-lib-crc-ccitt +kmod-usb-core
...
define KernelPackage/sfp
  ...
  DEPENDS:=@LINUX_5_4 +kmod-i2c-core +kmod-hwmon-core +kmod-phylink
  KCONFIG:= \
	CONFIG_SFP \
	CONFIG_MDIO_I2C
  FILES:= \
...
define KernelPackage/sfc
  ...
  DEPENDS:=@LINUX_5_4 @PCI_SUPPORT +kmod-mdio +kmod-lib-crc32c +kmod-ptp +kmod-hwmon-core
  KCONFIG:= \
	CONFIG_SFC \
	CONFIG_SFC_MTD=y \
...
define KernelPackage/sfc-falcon
  ...
  DEPENDS:=@LINUX_5_4 @PCI_SUPPORT +kmod-mdio +kmod-lib-crc32c +kmod-i2c-algo-bit
  KCONFIG:= \
	CONFIG_SFC_FALCON \
